    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacherinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orgs.TeacherInfo', verbose_name='所属机构')),
            ],
            options={
                'verbose_name': '课程信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='http://www.atguigu.com', verbose_name='视频连接')),
                ('add_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='添加时间')),
                ('courseinfo', models.ForeignKey(max_length=200, on_delete=django.db.models.deletion.CASCADE, to='courses.CourseInfo')),
            ],
            options={
                'verbose_name': '资源信息',
