...
class CourseInfo(models.Model):
    ...
    teacherinfo=models.ForeignKey(TeacherInfo,verbose_name='教师信息',on_delete=models.CASCADE)
...
class SourceInfo(models.Model):
    ...
    courseinfo=models.ForeignKey(CourseInfo,max_length=200,on_delete=models.CASCADE)
    add_time=models.DateTimeField(default=django.utils.timezone.now,verbose_name='添加时间')
    def __str__(self):
        return self.name
    class Meta:
