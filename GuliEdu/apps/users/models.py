...
class UserProfile(AbstractUser):
    ...
    gender=models.CharField(choices=(('boy','男'),('girl','女')),max_length=10,verbose_name='用户性别',default='女')
    ...
    add_time=models.DateTimeField(verbose_name='添加时间',default=django.utils.timezone.now)
...
class BannerInfo(models.Model):
    ...
    url=models.URLField(default='htttp://www.atguigu.com',max_length=200,verbose_name='图片链接')
